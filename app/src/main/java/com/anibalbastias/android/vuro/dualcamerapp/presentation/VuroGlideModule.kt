...
@GlideModule
class VuroGlideModule : AppGlideModule() {
    ...
    override fun registerComponents(context: Context, glide: Glide, registry: Registry) {
        registry.append(
            CustomImageSizeModel::class.java, InputStream::class.java,
...
class CustomImageSizeUrlLoaderFactory : ModelLoaderFactory<CustomImageSizeModel, InputStream> {
    ...
    override fun build(multiFactory: MultiModelLoaderFactory): ModelLoader<CustomImageSizeModel, InputStream> {
        ...
        val modelCache = ModelCache<CustomImageSizeModel, GlideUrl>(300)
        return CustomImageSizeUrlLoader(
            modelLoader,
            modelCache
        )
    }
